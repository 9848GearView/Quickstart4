...
@Autonomous(name = "V2RedSmall", group = "Examples")
@Configurable
public class V2RedSmall extends OpMode {
    ...
    public static class Paths {
        ...
        private Pose startPosition = new Pose(88,8, Math.toRadians(90));//need real angle
        private Pose launchPosition = new Pose(87, 20, Math.toRadians(68));
