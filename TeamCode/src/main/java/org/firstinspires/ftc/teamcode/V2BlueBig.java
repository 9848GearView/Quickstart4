...
public class V2BlueBig extends OpMode {
    ...
    public static class Paths {
        ...
        private Pose startPosition = new Pose(20,124, Math.toRadians(143.5));
        private Pose launchPosition = new Pose(50, 85, Math.toRadians(127));
        private Pose intake1End = new Pose(10, 53, Math.toRadians(180));
        private Pose intake1Curve1 = new Pose(41, 45);
        private Pose intake1Curve2 = new Pose(39, 56);
        private Pose shoot2Curve = new Pose(32, 55);
        private Pose intake2End = new Pose(17.5, 83.5, Math.toRadians(180));
        private Pose parkPosition = new Pose(44,78, Math.toRadians(270));
        ...
        public Paths(Follower follower) {
            ...
            intake1 = follower.pathBuilder().addPath(new BezierCurve(launchPosition, intake1Curve1, intake1Curve2, intake1End))
                    ...
                    .build();
            shoot2 = follower.pathBuilder().addPath(new BezierCurve(intake1End, shoot2Curve, launchPosition))
