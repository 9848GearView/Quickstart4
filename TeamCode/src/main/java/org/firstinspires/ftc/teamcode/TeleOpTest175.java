...
@TeleOp(name="TeleOpTest175", group="Iterative OpMode")
public class TeleOpTest175 extends OpMode {
    MecanumDrive chassis = null;
    LauncherV175 cannon = null;
    ...
    public void loop(){
        ...
        if (cannon.getLaunchState() == LauncherV175.LaunchState.IDLE) {
            //intake wheel begin
