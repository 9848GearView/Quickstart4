...
@Disabled
@Autonomous(name = "V2BlueSmall", group = "Examples")
@Configurable
public class V2BlueSmall extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Launcher Min Velocity :", cannon.getMinVelocity());
    ...
    public static class Paths {
        ...
        private Pose startPosition = new Pose(56,8, Math.toRadians(90));//need real angle
        private Pose launchPosition = new Pose(57, 20, Math.toRadians(112));
        private Pose intake1End = new Pose(9.5, 9.5, Math.toRadians(180));
        private Pose intake1Curve = new Pose(58, 13);
        private Pose intake2End = new Pose(10, 36.5, Math.toRadians(180));
        private Pose intake2Curve1 = new Pose(43, 39);
        private Pose intake2Curve2 = new Pose(42, 35);

        private Pose parkPosition = new Pose(44,21, Math.toRadians(90) );//need real angle
        ...
        public Paths(Follower follower) {
            shoot1 = follower.pathBuilder().addPath(new BezierLine(startPosition, launchPosition))
                    ...
                    .build();
            intake1 = follower.pathBuilder().addPath(new BezierCurve(launchPosition, intake1Curve, intake1End))
